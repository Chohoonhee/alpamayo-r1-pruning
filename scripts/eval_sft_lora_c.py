...
from sft_phase_c import apply_vlm_only_prune, apply_lora_vlm_kept_plus_expert
...
def load_trained_model_c(orig_weights, drop_layers_json, lora_checkpoint,
    ...
    drop_idx = apply_vlm_only_prune(m, drop_layers_json)
    for p in m.parameters(): p.requires_grad = False
    m = apply_lora_vlm_kept_plus_expert(m, drop_idx, r=lora_r, alpha=lora_alpha)
    sd = {}
