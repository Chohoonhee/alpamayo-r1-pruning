"""Eval Stage 2: base model + runtime VLM identity bypass + joint-loss LoRA checkpoint."""
...
from sft_stage2 import apply_lora_vlm_expert
...
def load_model(orig_weights, drop_layers_json, lora_checkpoint, lora_r, lora_alpha, device):
